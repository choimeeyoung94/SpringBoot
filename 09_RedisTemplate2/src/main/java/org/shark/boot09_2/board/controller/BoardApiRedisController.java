package org.shark.boot09_2.board.controller;

import java.time.LocalDateTime;

import org.shark.boot09_2.board.dto.BoardDTO;
import org.shark.boot09_2.board.service.BoardRedisService;
...
public class BoardApiRedisController {
	...
	public String deleteBoard(@PathVariable(value = "bid") Long bid) {
		boardRedisService.deletById(bid);
